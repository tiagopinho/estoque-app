    ...
    static renderProductsList(products, container) {
        ...
        try {
            if (!Array.isArray(products) || products.length === 0) {
                container.innerHTML = '<p style="text-align: center; color: var(--color-text-tertiary); padding: var(--spacing-lg);">Nenhum produto encontrado</p>';
                return;
            }
            ...
            const productCards = products.map(product => {
                ...
                const latest = product.validities && product.validities.length > 0 ? product.validities[0] : null;
            ...
            container.innerHTML = productCards || '<p style="text-align: center; color: var(--color-text-tertiary); padding: var(--spacing-lg);">Nenhum produto para exibir</p>';
            ...
            container.innerHTML = '<p style="text-align: center; color: red; padding: var(--spacing-lg);">Erro ao carregar produtos</p>';
        }
    }
